...
class _$_Todo implements _Todo {
  ...
  @override
  String toString() {
    return 'Todo(id: $id, title: $title, dueDate: $dueDate, modifiedTime: $modifiedTime, createdTime: $createdTime, status: $status)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, id, title, dueDate, modifiedTime, createdTime, status);
